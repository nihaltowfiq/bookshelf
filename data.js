// genre - scraped from the api (key is bookshelves)
const genre = [
  ...
  'Browsing: Encyclopedias/Dictionaries/Reference',
  ...
  "Children's History",
  'Browsing: Other',
  'Browsing: Sports/Hobbies/Motoring',
  'School Stories',
  ...
  'Horticulture',
  'Browsing: Science - Physics',
  'Physics',
  'Browsing: Health & Medicine',
  'Medicine',
  'Browsing: Science - Earth/Agricultural/Farming',
  ...
  'FR Science fiction',
  'Browsing: History - Royalty',
  "Children's Anthologies",
  'FR Education et Enseignement',
  'FR Nouvelles',
  'Notes and Queries',
  'Browsing: Drugs/Alcohol/Pharmacology',
  'Browsing: Reports & Conference Proceedings',
  'Scientific American',
  'Buddhism',
  'PT Biografia',
  'Photography',
  'Germany',
  'Browsing: Parenthood & Family Relations',
  'Browsing: Science - Chemistry/Biochemistry/Physics',
  'Chemistry',
  'IT Poesia',
  'Crafts',
  'Technology',
  'Browsing: Fashion & Costume',
  'Native America',
  ...
  'Engineering',
  'Manufacturing',
  'Browsing: History - Schools & Universities',
  'France',
  'Animal',
  ...
  'Prairie Farmer',
  'Astounding Stories',
  'Browsing: Journalism/Media/Writing',
  'Animals-Wild-Birds',
